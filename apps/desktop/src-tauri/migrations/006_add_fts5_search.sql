...
--
-- Note: This migration does NOT use IF NOT EXISTS because migrations are tracked by
-- rusqlite_migration and should only run once. Explicit failures help catch issues.
...
-- Indexes meeting titles (including empty titles) and platform for full-text search
...
-- Populate FTS table with existing meetings data
